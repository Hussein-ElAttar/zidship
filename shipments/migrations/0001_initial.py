# Generated by Django 4.0.1 on 2022-01-23 21:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('PENDING', 'pending'), ('CONFIRMED', 'confirmed'), ('IN_PROGRESS', 'in_progress'), ('DELIVERED', 'delivered'), ('CANCELED', 'canceled')], db_index=True, default=shipments.enums.ShipmentStatusEnum['PENDING'], max_length=100)),
